 ...
 * @author owen
 */
public class LateAppointmentsPanel extends javax.swing.JPanel {

    /**
     * Creates new form TodaysAppointmentsPanel
     */
    public LateAppointmentsPanel() {
        initComponents();
        for (Iterator<Object> it = BloodTestCenter.lateApps.theQueue.iterator(); it.hasNext();) {
